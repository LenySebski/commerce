...
import {
  ...
  ShopifyProductsPaginatedOperation,
...
const reshapeCollections = (
  ...
  for (const collection of collections) {
    if (collection) {
      const reshapedCollection = reshapeCollection(collection, basePath);
...
export async function getCollections(
  ...
  const collections = [
    ...
    ...reshapeCollections(shopifyCollections, basePath).filter(
...
export async function getProductsPaginated({
  ...
  const res = await shopifyFetch<ShopifyProductsPaginatedOperation>({
